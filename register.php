...
$url = "http://localhost/apslupmanager/";
$secret = "6LctC_oUAAAAAPOcFjyAU9Mg-bFqZXMkSvkkS9Vi";
$response = null;
...
<head>
    ...
    <title>Register page | Apslup </title>
                            ...
                            <fieldset>
                                <div class="form">
                                    ...
                                    <div id="username-field" class="field-wrapper input">
                                        ...
                                        <input class="form-control" placeholder="User Name" name="username" id="username" type="text" autofocus value="<?php if (isset($_POST['username'])) {
                                                                                                                                                            echo $_POST['username'];
                                                                                                                                                        } ?>"> <!-- retain the value inside the field -->
                                    ...
                                    <div id="email-field" class="field-wrapper input">
                                        ...
                                        <input class="form-control" placeholder="E-mail" name="email" id="email" type="email" value="<?php if (isset($_POST['email'])) {
                                                                                                                                            echo $_POST['email'];
                                                                                                                                        } ?>"> <!-- retain the value inside the field -->
                                    ...
                                    <div id="number-field" class="field-wrapper input">
                                        ...
                                        <input class="form-control" placeholder="Mobile" name="mobile" type="number" value="<?php if (isset($_POST['mobile'])) {
                                                                                                                                echo $_POST['mobile'];
                                                                                                                            } ?>"> <!-- retain the value inside the field -->
                                    </div>
                                    ...
                                    <div class="d-sm-flex justify-content-between">
                                        ...
                                        <div class="field-wrapper">
                                            <div class="g-recaptcha" data-sitekey="6LfHf_oUAAAAAGFagINItADb3E4olsgOvQoWHLKU">
                                            </div>

...
?>
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text">
                        <a href="index.php" class="nav-link"> APSLUP </a>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                            <li>
                                <a href="table_dt_basic.php"> Abia Central </a>
                            </li>
                            <li>
                                <a href="table_dt_basic-light.php"> Abia North </a>
                            </li>
                            <li>
                                <a href="table_dt_ordering_sorting.php"> Abia South </a>
                            </li>
                            <!-- <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="login.php"> Login Cover </a>
                            </li>
                            <li>
                                <a href="register.php"> Register Cover </a>
                            </li>
                            <li>
                                <a href="lockscreen.php"> Unlock Cover </a>
                            </li>
                            <li>
                                <a href="pass_recovery.php"> Recover ID Cover </a>
                            </li>
                        </ul>
                    </li>
    ...
    <script>
        ...
        $(function(){
            ...
            //determine if user is active or not by creating a sessionStorage object
            //capture date and time the user moves the mouse
            ...
            //compare storedTime with the current time
            function timeCompare(timeString)
            {
                var currentTime  =  new Date();
                var pastTime     =  new Date(timeString);
                var timeDiff     =  currentTime - pastTime;
                var minPast      =  Math.floor( (timeDiff / 1200000) );

                if(minPast > 1) // if its greater than 1min.
                {
                ...
                //read this object assign a data to a variable and append it's current time
                timeChecker();
